...
void Texture::RenderFlipped(int x, int y,  SDL_Rect* clip ,float Scalex,float Scaley)
{
    SDL_Rect renderQuad = { x, y, Scalex, Scaley };
  mGraphics->DrawTexture(mTex,clip,&renderQuad,0,SDL_FLIP_HORIZONTAL);
}
void Texture::RenderFlipped_Vertical(int x, int y,  SDL_Rect* clip ,float Scalex,float Scaley)
{
    SDL_Rect renderQuad = { x, y, Scalex, Scaley };
  mGraphics->DrawTexture(mTex,clip,&renderQuad,0,SDL_FLIP_VERTICAL);
}
Texture::~Texture()
{
    //dtor
